...
/** Global map zoom range — no regional bounds. */
export const MAP_MIN_ZOOM = 2
export const MAP_MAX_ZOOM = 18

/** @deprecated India bounds removed — map supports full-world panning with worldCopyJump. */
export const INDIA_MAP_MAX_BOUNDS: [[number, number], [number, number]] | undefined = undefined
export const MAP_MAX_BOUNDS_VISCOSITY = 0
