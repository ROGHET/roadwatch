...
const selectBaseClassName =
  'flex h-10 w-full min-w-0 cursor-pointer rounded-md border border-slate-300 bg-white pl-3 text-base text-slate-900 shadow-sm transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-900 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-600 dark:bg-slate-950 dark:text-slate-50 dark:focus-visible:outline-slate-100 sm:text-sm'
